...
func init() {
	...
	//这里的utils.G_mysql_addr和utils.G_mysql_port最终都会连到app.conf
	orm.RegisterDataBase("default", "mysql", "root:hh663775@tcp("+utils.G_mysql_addr+":"+utils.G_mysql_port+")/go1micro?charset=utf8", 30)
