...
$ ./configure --with-openssl=/home/miku/デスクトップ/新しいフォルダー/openssl-1.0.1t --with-pcre=/home/miku/デスクトップ/新しいフォルダー/pcre-8.40 --with-zlib=/home/miku/デスクトップ/新しいフォルダー/zlib-1.2.11 --with-http_ssl_module  --add-module=/home/miku/デスクトップ/新しいフォルダー/fastdfs-nginx-module/src 
#编译
$ make
#安装
$ make install
...
```shell
#我们在虚拟机中访问我们的资源图片
http://127.0.0.1/group1/M00/00/00/wKi2gmYEynmAYKktACRqGNZ_bkA710.jpg
#会出现如下效果
```
